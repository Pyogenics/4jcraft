...
// 4J Added
void MultiplayerLocalPlayer::setAndBroadcastCustomSkin(uint32_t skinId)
{
	uint32_t oldSkinIndex = getCustomSkin();
...
void MultiplayerLocalPlayer::setAndBroadcastCustomCape(uint32_t capeId)
{
	uint32_t oldCapeIndex = getCustomCape();
