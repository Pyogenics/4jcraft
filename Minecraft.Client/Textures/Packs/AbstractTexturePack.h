...
protected:
	AbstractTexturePack(uint32_t id, File *file, const std::wstring &name, TexturePack *fallback);
...
public:
	...
	virtual uint8_t* getPackIcon(uint32_t &dwImageBytes);
	virtual uint8_t* getPackComparison(uint32_t &dwImageBytes);
