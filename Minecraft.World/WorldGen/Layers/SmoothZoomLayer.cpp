...
SmoothZoomLayer::SmoothZoomLayer(int64_t seedMixup, std::shared_ptr<Layer>parent) : Layer(seedMixup)
{
	this->parent = parent;
}
...
std::shared_ptr<Layer>SmoothZoomLayer::zoom(int64_t seed, std::shared_ptr<Layer>sup, int count)
{
